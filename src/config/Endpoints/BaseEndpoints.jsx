...
export const OPPORTUNITY_API_BASE_URL = `${API_BASE_URL}opportunity`;
export const CERTIFICATION_AUTHORITY_API_BASE_URL = `${API_BASE_URL}certification-authority`;
...
export const PROGRAM_API_BASE_URL = `${API_BASE_URL}programs/`;
