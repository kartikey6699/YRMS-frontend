...
const TaskCard = ({ task, onEdit, setDeleteModal }) => {
    const [toast, setToast] = useState(null);

    const statusName = (status) => {
        let value = status.charAt(0).toUpperCase() + status.slice(1)
                ...
                <div className="w-4/5">
                    ...
                    <div className="flex justify-between items-center mt-2">
                        <div className="text-xs text-gray-500">
                            ...
                            <span>Created: {new Date(task.createdAt || task.deadline).toLocaleDateString()}</span>
                        </div>
